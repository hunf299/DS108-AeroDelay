...
| Nhan xet humidity-visibility cu qua chac ve capped | Tinh correlation all vs non-capped theo airport | `Source code/eda_weather_plan_notebook.ipynb`, `03_visibility_humidity_capped_sensitivity.csv`, `10_aviation_weather_operational_review.md` | Sua ket luan: capped la mot ly do lon, nhung non-capped corr van yeu; humidity khong du lam proxy truc tiep cho fog/visibility |
