...
def load_historical_data():
    try:
        df = pd.read_csv("18_24520617_24520636_Data/Gold_layer/Features/master_departure_features_gold_annotated.csv")
    except FileNotFoundError:
        try:
            df = pd.read_csv("18_24520617_24520636_Data/Gold_layer/Features/master_departure_features_gold.csv")
        except FileNotFoundError:
...
@st.cache_resource
def load_ml_model():
    model_path = Path("18_24520617_24520636_Source code/3-Feature Engineering & Model/models/best_aerodelay_model.pkl")
    features_path = Path("18_24520617_24520636_Source code/3-Feature Engineering & Model/models/best_model_features.pkl")
    if not model_path.exists():
        model_path = Path(
            "/18_24520617_24520636_Source code/3-Feature Engineering & Model/models/best_aerodelay_model.pkl")
        features_path = Path(
            "/18_24520617_24520636_Source code/3-Feature Engineering & Model/models/best_model_features.pkl")
    try:
