...
def run_pipeline(
    ...
    input_bronze_dir = project_root / "18_24520617_24520636_Data" / "Bronze_layer_cleaned"
    if not input_bronze_dir.exists():
        input_bronze_dir = project_root / "18_24520617_24520636_Data" / "Bronze_layer"
    arrival_dir = input_bronze_dir / "Arrival"
    departure_dir = input_bronze_dir / "Departure"

    silver_dir = project_root / "18_24520617_24520636_Data" / silver_layer_name
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help=f"Output silver layer folder name under 18_24520617_24520636_Data. Default: {DEFAULT_SILVER_LAYER_NAME}.",
    )
