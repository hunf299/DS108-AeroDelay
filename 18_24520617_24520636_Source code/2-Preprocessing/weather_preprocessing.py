...
def load_bronze_weather(project_root: Path) -> pd.DataFrame:
    ...
    bronze_path = (
        project_root / "18_24520617_24520636_Data" / "Bronze_layer" / "airport_weather_hourly_merged.csv"
    )
...
def run_weather_pipeline(
    ...
    silver_root = project_root / "18_24520617_24520636_Data" / silver_layer_name
